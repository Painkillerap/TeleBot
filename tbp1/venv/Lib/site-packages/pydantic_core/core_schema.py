...
def no_info_wrap_validator_function(
    ...
    *,
    ...
    "onion" implementation of middlewares in many popular web frameworks, no `info` argument is passed, e.g.:
...
def with_info_wrap_validator_function(
    ...
    *,
    ...
    Returns a schema which calls a function with a `validator` callable argument which can
    optionally be used to call inner validation with the function logic, this is much like the
    "onion" implementation of middlewares in many popular web frameworks, an `info` argument is also passed, e.g.:
