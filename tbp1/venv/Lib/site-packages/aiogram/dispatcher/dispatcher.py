...
class Dispatcher(Router):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # User context middlewares makes small optimization for all other builtin
        # middlewares via caching the user and chat instances in the event context
        self.update.outer_middleware(UserContextMiddleware())

        # FSM middlewares should always be registered after User context middlewares
        ...
        if not disable_fsm:
            # Note that when FSM middlewares is disabled, the event isolation is also disabled
