...
class I18nMiddleware(BaseMiddleware, ABC):
    ...
    def __init__(
        ...
        """
        Create an instance of middlewares

        :param i18n: instance of I18n
        :param i18n_key: context key for I18n instance
        :param middleware_key: context key for this middlewares
        """
        self.i18n = i18n
    ...
    def setup(
        ...
        """
        Register middlewares for all events in the Router
...
class ConstI18nMiddleware(I18nMiddleware):
    """
    Const middlewares chooses statically defined locale
    """
...
class FSMI18nMiddleware(SimpleI18nMiddleware):
    """
    This middlewares stores locale in the FSM storage
    """
