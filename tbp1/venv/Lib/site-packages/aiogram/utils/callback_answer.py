...
class CallbackAnswer:
    def __init__(
        ...
        :param answered: this request is already answered by middlewares
    ...
    def answered(self) -> bool:
        """
        Indicates that request is already answered by middlewares
        """
...
class CallbackAnswerMiddleware(BaseMiddleware):
    def __init__(
        ...
        """
        Inner middlewares for callback query handlers, can be useful in bots with a lot of callback
